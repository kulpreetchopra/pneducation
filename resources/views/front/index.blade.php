          ...
          <hr>
            <center>
              <h3 style="background-color:#07a6f02b">
                ...
                &nbsp;
                <a class="icon" style="background-color: #1DA1F2;" href="{{$a->twitter}}"><i class="fa fa-twitter"></i></a>
                &nbsp;
                <a class="icon" style="background-color: #d7078e;" href="{{$a->instagram}}"><i class="fa fa fa-instagram"></i></a>
                &nbsp;
                <a class="icon" style="background-color: #2867B2;" href="{{$a->linkedin}}"><i class="fa fa-linkedin"></i></a>
                @endforeach
              </h3>
            </center>
