...
@section("title","Edit Banner | PN-Education")
@section("content")
 ...
 <!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="card-tools">
                  <a class="btn btn-info btn-sm" href="{{url('admin/banner')}}">View Banner</a>
               </div>
              </div>
              <div class="card-body">
    <!-- /.content-header -->
    ...
    <div class="form-group">
      <label>Image:</label>&nbsp;&nbsp;&nbsp;&nbsp;
      <img src="{{ url('/front/'.$edit->bgimage) }}" style="height: 120px; width: 120px; border-radius: 100%;"><br><br>
      <input type="file" class="form-control" name="bgimage">
    </div>
    <div class="form-group">
      <label>Discription:</label>
      <textarea type="text" class="form-control" placeholder="Enter Banner Description" name="discription">{{$edit->discription}}</textarea>
    </div>
