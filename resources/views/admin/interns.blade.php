...
@section("title","Interns | PN-Education")
@section("content")
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Our Interns</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{url('admin')}}">Home</a></li>
              <li class="breadcrumb-item active">Our Interns</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
        @if(session('message'))
...
<section class="content">
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Display Interns</h3>
              ...
              <table id="example1" class="table table-bordered table-hover table-striped table-responsive-sm">
                ...
                <tbody>
                  ...
                  <tr style="text-align: center;">
                    ...
                    <td>{{$a->designation}}</td>
                    <td>
                      <a href="{{url('admin/interns_edit/'.$a->id)}}"><p class="btn btn-success"><i class="fas fa-edit"></i></p></a>
                      <a onclick="return confirm('Are you sure to delete?')" href="{{url('admin/interns_delete/'.$a->id)}}"><p class="btn btn-danger"><i class="fas fa-trash"></i></p></a>
                    </td>
                  </tr>
                  @endforeach
                </tbody>
  ...
  <span aria-hidden="true">&times;</span>
      ...
      <form method="post" action="{{url('admin/interns_submit')}}" enctype="multipart/form-data">
      @csrf
